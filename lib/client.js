window.__ModuleLoader__.load({
  ...
  factory: (require) => {
     ...
     */
    var CLIENT_BUILD = 'tavern-client-2.6.2'
        ...
        var bubbles = chat.messages.map(function (message, index) {
          return React.createElement(
            ...
            typeof message.reasoning === 'string' && message.reasoning !== ''
              ...
              : null,
            React.createElement('div', { className: 'dsh-tv-bubbleText' }, renderMessage(message.text, message.name)),
          )
        })
        ...
        if (chat.liveThought !== '' || chat.live !== '') {
          bubbles.push(
            React.createElement(
              ...
              chat.live === ''
                ? null
                : React.createElement('div', { className: 'dsh-tv-bubbleText' }, renderMessage(chat.live, selected.character)),
            ),
          )
        }
